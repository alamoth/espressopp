...
void gpu_resizeParticleData(    int N, 
    ...
    cudaMalloc(d_pos,   sizeof(realG4) * N);                                                           CUERR
    cudaMalloc(d_force, sizeof(realG4) * N);                                                           CUERR
    cudaMalloc(d_mass, numBytesD);                                                                      CUERR
    cudaMalloc(d_drift, numBytesD);                                                                     CUERR
    cudaMalloc(d_real, sizeof(bool) * N);                                                               CUERR

    cudaMemset(*d_force, 0, sizeof(realG4) * N);                                                       CUERR
...
void gpu_h2dParticleVars(   int N,
    ...
    cudaMemcpy(*d_pos, h_pos, sizeof(realG4) * N, cudaMemcpyHostToDevice);                             CUERR
